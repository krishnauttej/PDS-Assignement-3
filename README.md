Q1)Use any open-source API to access some data in Jason format and then parse the Jason data and
...
Q2) The data file diabetes.csv contains data of 768 patients. In this data there are 8 attributes
